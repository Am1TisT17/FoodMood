    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F0F7EC] to-white flex items-center justify-center px-4 py-12">
      ...
      >
          ...
          {!submitted ? (
            <>
              ...
              <p className="text-sm text-[#4A5568]/70 mb-6">
                Enter the email associated with your FoodMood account and we will send you a link to reset your password.
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#4A5568]/70 mb-6">
                If <span className="font-medium text-[#4A5568]">{email}</span> is registered with FoodMood, a password reset link has just been sent. The link is valid for 1 hour.
              </p>
              <Link
                to="/login"
        ...
        <p className="text-center text-xs text-[#4A5568]/50 mt-6">
          Didn't get an email? Check your spam folder, then try again in a few minutes.
        </p>
      </motion.div>
    </div>
  );
